...
public class SilvaniaStructure extends Structure<NoFeatureConfig> {
	   public SilvaniaStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49883_1_) {
	      super(p_i49883_1_);
	   }
	   ...
	   public Structure.IStartFactory getStartFactory() {
	      return SilvaniaStructure.Start::new;
	   }
	   ...
	   public static class Start extends StructureStart {
	      ...
	      public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
	         ...
	         int i = SilvaniaStructure.getYPosForStructure(chunkX, chunkZ, generator);
	         if (i >= 60) {
	            BlockPos blockpos = new BlockPos(chunkX * 16 + 8, i, chunkZ * 16 + 8);
	            SilvaniaPieces.startHouseTower(templateManagerIn, blockpos, rotation, this.components, this.rand);
